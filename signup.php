...
if(isset($_REQUEST['username'])){
	...
	if($result){
		echo "<div class='form'><p>Registered successfully</p><br/><p>Click here to <a href='login.php'>Login</a></p></div>";
	}
}
else{
?>
      ...
      <div class="col-md-6 mx-auto">
        <div class="block text-center">
          ...
          <form class="text-left clearfix mt-30" action="index.html">
            ...
            <button type="submit" name="submit" value="submit"class="btn btn-main text-center">Sign In</button>
          </form>
